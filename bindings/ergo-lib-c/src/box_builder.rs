...
pub unsafe extern "C" fn ergo_wallet_ergo_box_candidate_builder_new(
    ...
    let res = ergo_box_candidate_builder_new(value_ptr, contract_ptr, creation_height, builder_out);
...
pub unsafe extern "C" fn ergo_wallet_ergo_box_candidate_builder_min_box_value_per_byte(
    ...
    match ergo_box_candidate_builder_min_box_value_per_byte(builder_ptr) {
        Ok(value) => ReturnNum {
            value,
...
pub unsafe extern "C" fn ergo_wallet_ergo_box_candidate_builder_set_value(
    ...
    let res = ergo_box_candidate_builder_set_value(builder_mut, value_ptr);
    Error::c_api_from(res)
}
...
pub unsafe extern "C" fn ergo_wallet_ergo_box_candidate_builder_value(
    ...
    let res = ergo_box_candidate_builder_value(builder_ptr, value_out);
    Error::c_api_from(res)
}
...
pub unsafe extern "C" fn ergo_wallet_ergo_box_candidate_builder_set_register_value(
    ...
    let res = ergo_box_candidate_builder_set_register_value(builder_mut, register_id, constant_ptr);
    Error::c_api_from(res)
}
...
pub unsafe extern "C" fn ergo_wallet_ergo_box_candidate_builder_delete_register_value(
    ...
    let res = ergo_box_candidate_builder_delete_register_value(builder_mut, register_id);
    Error::c_api_from(res)
}
...
pub unsafe extern "C" fn ergo_wallet_ergo_box_candidate_builder_mint_token(
    ...
    let res = ergo_box_candidate_builder_mint_token(
        builder_mut,
        token_ptr,
        &token_name,
        &token_desc,
...
pub unsafe extern "C" fn ergo_wallet_ergo_box_candidate_builder_add_token(
    ...
    let res = ergo_box_candidate_builder_add_token(builder_mut, token_id_ptr, token_amount_ptr);
    Error::c_api_from(res)
}
