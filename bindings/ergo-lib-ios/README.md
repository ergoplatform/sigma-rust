...
> **Note:** This project requires Xcode 15+ and the latest stable Rust toolchain.
> Older Xcode versions (13) are no longer supported due to Swift package manager changes.
