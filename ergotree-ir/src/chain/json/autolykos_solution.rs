...
pub(crate) fn bigint_as_str<S>(value: &BigInt, serializer: S) -> Result<S::Ok, S::Error>
where
    S: serde::Serializer,
{
...
pub(crate) fn bigint_from_serde_json_number<'de, D>(deserializer: D) -> Result<BigInt, D::Error>
where
    D: Deserializer<'de>,
{
    use serde::de::Error;
